...
from .env import base_dir, torch_device
from .model import build_model

# Raiz del proyecto (repo root local; /content o /kaggle/working en la nube).
# Lee data/, templates.json y checkpoints/ de aca.
ROOT = base_dir()
